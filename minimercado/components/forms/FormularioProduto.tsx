...
import { supabase } from '@/lib/supabase'; // 🟢 O seu novo caminho limpo!
...
export default function FormularioProduto() {
  ...
  // =========================================================================
  // 2. SALVAR NOVA CATEGORIA (INSERT)
  // =========================================================================
  ...
  // =========================================================================
  // 3. SALVAR IMAGEM NO STORAGE E PRODUTO NO BANCO (INSERT)
  // =========================================================================
    ...
    try {
      ...
      if (imagem) {
        ...
        const { error: uploadError } = await supabase.storage
          .from('produtos') // ⚠️ Você precisará criar esse bucket no painel do Supabase
      ...
      // Salva o produto na tabela Product (IDêntico ao seu DER)
        ...
        .insert([
          {
            ...
            image_url: imageUrlSalvaNoBanco     
          }
        ]);
