...
export function SkeletonProduto() {
  return (
    <div className="bg-white p-3 rounded-xl border border-gray-100 flex flex-col items-center w-full animate-pulse shadow-sm">
      {/* Imagem do produto (Quadrado cinza super claro) */}
      ...
      {/* Preço (Deixamos um pouquinho diferente para dar contraste, mas suave) */}
      <div className="h-4 bg-gray-200 rounded w-1/3 mb-3 mt-auto"></div>
