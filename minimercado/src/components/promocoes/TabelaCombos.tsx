  ...
  return (
    <div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
          ...
          {/* 🟢 Aqui entra a mágica do Scroll Vertical e Horizontal */}
          <div className="max-h-[340px] overflow-y-auto overflow-x-auto">
            
            {/* 🟢 Adicionamos whitespace-nowrap para as colunas não se espremerem no mobile */}
            <table className="w-full text-left border-collapse whitespace-nowrap">
                
                {/* 🟢 sticky top-0 z-10 faz o cabeçalho ficar fixo ao rolar para baixo */}
                ...
                <tbody className="divide-y">
                    {combos.map(combo => (
                        <tr key={combo.id} className="hover:bg-gray-50">
                            ...
                            <td className="p-4 text-xs italic truncate max-w-[200px]" title={combo.itens}>{combo.itens}</td>
